  ...
  return (
    <li>
      ...
      >
        ...
        <span className="font-sans text-2xl mr-2 select-none">{props.question}</span>
        <Chevron className={`${isOpen ? 'rotate-0' : 'rotate-180'} duration-500 w-4 h-4`} />
      </div>
      <div
      ...
      >
        <p className="font-sans text-black text-xl mt-2 mb-4 pl-6">{props.answer}</p>
      </div>
