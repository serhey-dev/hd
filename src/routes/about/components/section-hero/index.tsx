      ...
      <div className="container z-20 relative py-16 flex flex-row items-center min-h-screen">
        <div className="px-2 w-full xl:w-1/2 lg:w-2/3">
          <div className="text-center px-5 md:px-0 xl:ml-12">
            ...
            <p className="font-sans italic text-black text-lg">
              Все це для того - щоб Ви, мій шановний клієнте обов’язково досягли своєї мети. А я
              буду поруч з Вами на цьому шляху - для того, щоб підсвітити все те що пролітає повз
              наше сприйняття.
            </p>
          </div>
        </div>
